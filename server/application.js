...
const proxyManager = createProxyManager({ panelDb: db, dataDir: config.paths.dataDir });
...
// 内嵌的 Proxy Manager：路由挂面板自身会话鉴权之后，前端页面由 public 静态目录提供。
app.use('/api/proxy-manager', proxyManager.router);
